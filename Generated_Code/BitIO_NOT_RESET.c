...
**     Settings    :
**          Component name                                 : BitIO_NOT_RESET
...
**          Safe mode                                      : no
**     Contents    :
**         Init   - LDD_TDeviceData* BitIO_NOT_RESET_Init(LDD_TUserData *UserDataPtr);
**         GetVal - bool BitIO_NOT_RESET_GetVal(LDD_TDeviceData *DeviceDataPtr);
**         PutVal - void BitIO_NOT_RESET_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val);
**         ClrVal - void BitIO_NOT_RESET_ClrVal(LDD_TDeviceData *DeviceDataPtr);
**         SetVal - void BitIO_NOT_RESET_SetVal(LDD_TDeviceData *DeviceDataPtr);
**
...
/*
** ===================================================================
**     Method      :  BitIO_NOT_RESET_GetVal (component BitIO_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
bool BitIO_NOT_RESET_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  uint32_t portData;                   /* Port data masked according to the bit used */

  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */

  portData = GPIO_PDD_GetPortDataOutput(BitIO_NOT_RESET_MODULE_BASE_ADDRESS) & BitIO_NOT_RESET_PORT_MASK;
...
/*
** ===================================================================
**     Method      :  BitIO_NOT_RESET_PutVal (component BitIO_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void BitIO_NOT_RESET_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */

  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(BitIO_NOT_RESET_MODULE_BASE_ADDRESS, BitIO_NOT_RESET_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(BitIO_NOT_RESET_MODULE_BASE_ADDRESS, BitIO_NOT_RESET_PORT_MASK);
  } /* !Val */
}

/*
** ===================================================================
**     Method      :  BitIO_NOT_RESET_ClrVal (component BitIO_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void BitIO_NOT_RESET_ClrVal(LDD_TDeviceData *DeviceDataPtr)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
...
/*
** ===================================================================
**     Method      :  BitIO_NOT_RESET_SetVal (component BitIO_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void BitIO_NOT_RESET_SetVal(LDD_TDeviceData *DeviceDataPtr)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
